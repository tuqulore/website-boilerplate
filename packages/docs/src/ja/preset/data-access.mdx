...
| `eleventy.title`, `eleventy.description`, etc. | `export const data` に書いた各値                                                                           |
| `eleventy.site`, `eleventy.nav`, etc.          | グローバルデータ (`_data/` 配下) のトップレベルキー                                                        |
| `eleventy.page`                                | Eleventy の [`page` 変数](https://www.11ty.dev/docs/data-eleventy-supplied/#page-variable) (URL、日付など) |
| `eleventy.locale`                              | `export const data.locale` に書いた値                                                                      |
