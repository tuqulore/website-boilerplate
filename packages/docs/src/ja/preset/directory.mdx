...
[レイアウトチェイニング](https://www.11ty.dev/docs/layout-chaining/) 用の [レイアウトテンプレート](https://www.11ty.dev/docs/layouts/) を置く場所です。ページの frontmatter で `layout: "..."` と指定した対象がここから探されます。
