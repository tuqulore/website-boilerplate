...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Page template: Markdown mixed with JSX</td>
    </tr>
    <tr>
      <td>
        <code>.jsx</code>
      </td>
      <td>JSX template or partial</td>
    </tr>
    <tr>
      <td>
        <code>.client.jsx</code> etc.
      </td>
      <td>Client-side components (Islands)</td>
    </tr>
    <tr>
      <td>
        <code>.css</code>
      </td>
      <td>Stylesheet processed by PostCSS</td>
    </tr>
    <tr>
      <td>Others</td>
      <td>Handled by Eleventy defaults or passed through</td>
    </tr>
  </tbody>
</table>
