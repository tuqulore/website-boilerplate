...
Where the [layouts](https://www.11ty.dev/docs/layouts/) for [layout chaining](https://www.11ty.dev/docs/layout-chaining/) live. When a page's `layout: "..."` in its frontmatter resolves, Eleventy looks under this directory.
