...
The writing side of layout chaining, page data, and the split between MDX and JSX are all covered in [Preset Conventions / Templates](/en/preset/templates/).
