...
| Value         | Where it fits                                                                                         |
| ------------- | ----------------------------------------------------------------------------------------------------- |
| `interaction` | Wait until the user clicks or focuses. Fits most buttons and forms. This is the default.              |
| `visible`     | Hydrate when the element scrolls into view. Fits interactive blocks lower on the page.                |
| `idle`        | Hydrate once the browser is idle. Fits lightweight UI that has to work right after the initial paint. |
