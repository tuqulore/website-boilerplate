...
Once the site is up, continue with the "Write your first page" page (translation in progress; see the [Japanese page](/ja/getting-started/first-page/) for now) to replace the scaffold placeholder. To grasp the directory layout first, jump to the "Project structure" page (translation in progress; see the [Japanese page](/ja/getting-started/structure/) for now).
